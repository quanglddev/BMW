...
const AppBarLarge = () => {
  ...
  return (
    <div className="flex-col items-center fixed top-0 left-0 bottom-0 w-36 bg-red-dark-99 z-50 hidden lg:flex justify-between">
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <Settings className="fill-current w-10 h-10 ml-2"></Settings>
        ...
        >
          <Help className="fill-current w-10 h-10 ml-2"></Help>
          <div className="text-white ml-2">Info</div>
        </button>
